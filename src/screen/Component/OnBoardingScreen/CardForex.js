        ...
        <View style={styles.mainStyle}>
          <View style={{ flexDirection: "row", marginTop: 10 }}>
            <View style={{
              ...
              borderRadius: 10, marginLeft: 5, borderColor: "#5DADE2", borderWidth: 1
            }}>
          ...
          <View style={{ flexDirection: "row", marginTop: 9 }}>
            <View style={{
              heigh: 40, width: 55, marginTop: 4,
              borderRadius: 10, marginLeft: 5, borderColor: "#5DADE2",
            ...
            <View style={{ width: "80%", marginHorizontal: 10 }}>
              <SelectList
                ...
                data={data}
                save="value"
                arrowicon={<FontAwesome name="chevron-down" size={18} color={'#5DADE2'}
                />}
                searchicon={<FontAwesome name="search" size={18} color={'#5DADE2'}
                  style={{ marginRight: 19 }} />}
                inputStyles={{ fontSize: 15, fontWeight: "bold", color: "#5DADE2" }}
                dropdownStyles={{ backgroundColor: "white", borderColor: "#5DADE2" }}
          ...
          <View style={{ flexDirection: "row", marginTop: 9 }}>
            <View style={{
              heigh: 40, width: 55, marginTop: 4,
              borderRadius: 10, marginLeft: 5, borderColor: "#5DADE2", borderWidth: 1, justifyContent: "center"
            }}>
